...
def main():
  ...
  for x in range(start, stop, 1):
    ...
    if(adonisJS):
      ...
      print(".raw(\"INSERT INTO `groups` (id, user_id, name, group_img, type, created_at, updated_at) values (%s, %s, '%s', 'https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/samuel-67197_1280.jpg', %s, '2019-12-01 00:00:00', '2019-12-01 00:00:00')\")" % (x, x, alias[random.randint(1,len(alias))], random.randint(1,3) ) )
    else:
      ...
      print("INSERT INTO `groups` (id, user_id, name, group_img, type, created_at, updated_at) values (%s, %s, '%s', 'https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/samuel-67197_1280.jpg', %s, '2019-12-01 00:00:00', '2019-12-01 00:00:00');" % (x, x, alias[random.randint(1,len(alias))], random.randint(1,3) ) )
