...
Route.get('/api/ScheduleGame/delete/:id', 'ScheduleGameController.destroy')
...
Route.get('/api/myScheduledGames/:limitstr', 'ScheduleGameController.myScheduledGames')
...
Route.post('/api/notifications/updateRead_Status_groups/:group_id/:user_id', 'NotificationController.updateRead_Status_groups')
...
Route.get('/api/notifications/getunread_group/:id/:user_id', 'NotificationController.getunread_group')
...
Route.get('/api/attendees/allattending/:id', 'AttendeeController.show_Allattending')
