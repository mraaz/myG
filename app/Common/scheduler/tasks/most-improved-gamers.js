module.exports = async (job) => {
  ...
  const UserStatTransactionController = require('../../../Controllers/Http/UserStatTransactionController')
  await new UserStatTransactionController().setMostImprovedGamer()
