...
class EmailController {
  ...
  async encryption_email(email, pin) {
    ...
    const subject = "myG Chat Encryption key - CONFIDENTIAL COMMUNICATION"
    const body = `Hi, <br> This key will be used to access your chat history.<br><strong>${pin}</strong><br> Everytime you log off, you key is cleared and when you log back in, you will need to RE-ENTER this key. Failure to do so will disable chat and if a new key is generated, you will LOSE all your previous chat history. <br> This is a true End to End encryption chat, meaning myG doesn't have any visibility of your messages or your key. Therefore we cannot retrieve messages or key if they are lost <br> Cheers, <br> Raaz`;
