...
class TeamController {
  async createTeam({ auth, request, response }) {
    try {
      ...
      const payload = request.only(['name', 'games', 'image', 'hashtags', 'moderators', 'type', 'region', 'language', 'description', 'autoAcceptGamers', 'listOnLFT', 'recruiting', 'exclusive', 'invitationOnly', 'invitedFriends']);
