...
const ScheduleGames = Loadable({
  loader: () => import('./components/ScheduleGames'),
  loading: function() {
    return null
  },
})

const MyScheduledGames = Loadable({
  loader: () => import('./components/MyScheduledGames'),
  loading: function() {
    return null
  },
})
...
const ScheduledGamePost = Loadable({
  loader: () => import('./components/ScheduledGamePost'),
  loading: function() {
    return null
  },
})
...
const PlayerList = Loadable({
  loader: () => import('./components/PlayerList'),
  loading: function() {
    return null
  },
})
