        ...
        return (
          <div className="file-preview-wrap">
            <div className="file-preview-overlay">
              <span className="file-preview-delete" onClick={() => this.clickDelete()}><i className="fas fa-times"></i></span>
            </div>
            <video controls>
      ...
      <div className={"modal-container " + class_modal_status}>
        <div className="modal-wrap">
            ...
            <div className="modal-content">
                <textarea name="post_content" rows={8} cols={80} defaultValue={''} onChange={this.handleChange} value={this.state.post_content} maxLength="254" placeholder="What's up..."/>
                <input id="myInput"
                    type="file"
