        ...
        <div className="content-area addGamingExp-page">
          <Modal
            ...
            <div className="options_checkbox">
              ...
              <input id="comments_ChkBox" type="checkbox" defaultChecked={comments_chkbox_state} onChange={this.toggleChange_comments}/> Comments
            </div>
            ...
            {this.state.link_chkbox == false ? <div className="link_txtBox"></div> : <div className="link_txtBox">
              <p>Link</p>
              <input type="text" id="link_box" className="link_box" maxLength="50" defaultValue = {`${link}`} onChange={this.handleChange} />
            </div> }

            {this.state.comments_chkbox == false ? <div className="comments"></div> : <div className="comments">
              <p>Comments</p>
              <textarea id="comments_box" className="comments_box" rows={8} cols={80} defaultValue={`${comments}`} maxLength="254" onChange={this.handleChange}/>
            </div>}
            <div></div>
            ...
            <div className="save-btn">
              <button className="delete" onClick={() => { if (window.confirm('Are you sure you wish to delete this Gaming Experience?')) this.delete_exp() } }>Delete</button>&nbsp;
