      ...
      <div className="card-container">
        ...
        <div className="card-round">
          ...
          <a href="/login/facebook" className="button facebook-btn">
            <img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Facebook_SSO.svg" className="sso-logo" height="25" width="25" />
            <div className="sso-text">Create with Facebook</div>
          </a>
          <a href="/login/google" className="button google-btn">
            <img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Google_SSO.svg" className="sso-logo" height="25" width="25" />
            <div className="sso-text">Create with Google</div>
          </a>
          <a href="/login/steam" className="button steam-btn">
            <img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Steam_SSO.svg" className="sso-logo" height="25" width="25" />
            <div className="sso-text">Create with Steam</div>
          </a>
          <a href="/login/discord" className="button discord-btn">
            <img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Discord_SSO.svg" className="sso-logo" height="25" width="25" />
