    ...
    return (
      <div className='card-container'>
        <div className='logo-on-card'>
          <img
            src='https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Card_Logo.svg'
            height='90'
            width='90'
          />
        </div>
        <div className='card-round'>
          ...
          <a href='/login/facebook' className='button facebook-btn'>
            <img
              src='https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Facebook_SSO.svg'
              className='sso-logo'
              height='25'
              width='25'
            />
          ...
          <a href='/login/google' className='button google-btn'>
            <img
              src='https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Google_SSO.svg'
              className='sso-logo'
              height='25'
              width='25'
            />
          ...
          <a href='/login/steam' className='button steam-btn'>
            <img
              src='https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Steam_SSO.svg'
              className='sso-logo'
              height='25'
              width='25'
            />
          ...
          <a href='/login/discord' className='button discord-btn'>
            <img
              src='https://mygame-media.s3-ap-southeast-2.amazonaws.com/platform_images/Login+Screen/Discord_SSO.svg'
              className='sso-logo'
              height='25'
              width='25'
            />
