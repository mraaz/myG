...
import { prepareChatAction, fetchMessagesAction, sendMessageAction, editMessageAction, deleteMessageAction, addReactionAction, removeReactionAction, updateChatStateAction } from '../../../redux/actions/guestAction';
...
function mapDispatchToProps(dispatch) {
  return ({
    ...
    addReaction: (chatId, userId, messageId, reactionId, senderName) => dispatch(addReactionAction(chatId, userId, messageId, reactionId, senderName)),
