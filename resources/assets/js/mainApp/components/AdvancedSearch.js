...
export default class AdvancedSearch extends Component <*, State> {
  ...
  componentWillMount(){
    ...
    const getInitialData = async function(){
      try{
        const allGameExperiences = await axios.get(`/api/GameExperiences/filtered/${myGame_name_box}/${myStatus}/${myExperience}/${myPlayed}/${myRatings}/${myCommendation}/${myTags}/${myCountry}`)
        self.setState({
  ...
  async pullData() {
    ...
    if (myTable == "Gaming Experience"){
      ...
      const alleSportsExperiences = await axios.get(`/api/esports_experiences/filtered/${myGame_name_box}/${myRole_title}/${myTeam_name}/${myTime_role}/${myTags}/${myCountry}`)
    ...
    if (this.state.allGameExperiences !== undefined){
      ...
      return (
        <section id="posts">
          ...
          <div id="header-2"><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/headers/headers_v1-12.png" /></div>
            <div className="filterMenu">
              ...
              {show_gaming_exp && <div className="gaming-experience">
              ...
              {!show_gaming_exp && <div className="esports-experience">
                <div className="row-two">
                  <div className="role-title">
                    <input type="text" className="role-title-box" onChange={this.handleChange_role_title} value={this.state.role_title_box} placeholder="Role Title" />
                  </div>
                  <div className="team-name">
                    <input type="text" className="team-name-box" onChange={this.handleChange_team_name} value={this.state.team_name_box} placeholder="Team Name" />
                  </div>
