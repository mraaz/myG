  ...
  renderLinkTabs = () => {
    ...
    return (
      <div className="chat-group-links-tabs">
        <div className={`chat-group-links-tab clickable ${this.state.currentTab === 0 && selectedStyle}`} onClick={() => this.setState({ currentTab: 0 })}>
          Link A
        </div>
        <div className={`chat-group-links-tab clickable ${this.state.currentTab === 1 && selectedStyle}`} onClick={() => this.setState({ currentTab: 1 })}>
          Link B
        </div>
        <div className={`chat-group-links-tab clickable ${this.state.currentTab === 2 && selectedStyle}`} onClick={() => this.setState({ currentTab: 2 })}>
          Link C
        </div>
      </div>
    );
    ...
    return (
      <div className="chat-group-links-current-tab-container">
        <div className="chat-group-links-current-link-container">
          <div className="chat-group-links-current-link">
            {linkURL}
          </div>
        </div>
        <div className={`chat-group-links-copy-button clickable`}
