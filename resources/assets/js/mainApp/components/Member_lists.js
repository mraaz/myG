    ...
    if(this.state.allGroupies !== undefined) {
      return (
        <section id="invitation-page">
          ...
          <div id="header" ><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/headers/headers_v1-16.png" /></div>
            {this.state.show_settings && <div className="group-settings">
            ...
            <div className="padding-container">
              <div className="invitation-grey-container">
                <h3>Members - ({(this.state.allGroupies.length == 1) ?  this.state.allGroupies.length + ' member' : this.state.allGroupies.length + ' members'})</h3>
                <div className="padding-container">
                </div>
