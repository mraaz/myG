        ...
        return (
          <div className="content-area addEsportsExp-page">
            <Modal
              ...
              <div className="email">
                <p>Email Visible? <span style={{color: "red"}}>*</span></p>
                <Select
              ...
              <div className="career-highlights">
                ...
                <textarea id="career_highlights_box" className="career_highlights_box" rows={8} cols={80} defaultValue={career_highlights} maxLength="254" onChange={this.handleChange}/>
              </div>
              ...
              <div className="role-title">
                <p>Role Title <span style={{color: "red"}}>*</span></p>
                <input type="text" id="role_title_box" className="role_title_box" maxLength="120" onChange={this.handleChange} defaultValue={`${role_title}`}/>
              </div>
              ...
              <div className="team-name">
                <p>Team name</p>
                <input type="text" id="team_name_box" className="team_name_box" maxLength="120" onChange={this.handleChange} defaultValue={`${team_name}`}/>
              </div>
              <div className="played">
                <p>Time in Role: <span style={{color: "red"}}>*</span></p>
                <Select
              ...
              <div className="achievements">
                ...
                <textarea id="achievements_box" className="achievements_box" rows={8} cols={80} defaultValue={`${achievements}`} maxLength="254" onChange={this.handleChange}/>
              </div>
              <div className="tag_txtBox">
                <p><span style={{color: "green"}}>S</span><span style={{color: "dodgerblue"}}>k</span><span style={{color: "red"}}>i</span><span style={{color: "gold"}}>l</span><span style={{color: "green"}}>l</span><span style={{color: "dodgerblue"}}>s</span> (Keywords that identify <span style={{color: "green"}}>y</span><span style={{color: "dodgerblue"}}>o</span><span style={{color: "red"}}>u</span><span style={{color: "gold"}}>r</span> expertise with this role. Max 250 chars)</p>
                <CreatableSelect
              ...
              <div className="save-btn">
                <button className="delete" onClick={() => { if (window.confirm('Are you sure you wish to delete this Esports Experience?')) this.delete_exp() } }>Delete</button>
