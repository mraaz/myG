...
export const Content = ({ children }) => <div className='team-content'>{children}</div>
...
export const BottomBar = ({ intl, loading, onCancel, onCreate }) => (
  <div className='team-bottom-bar'>
    <MyGButton secondary onClick={onCancel} text={intl.formatMessage({ id: 'myg.cancel', defaultMessage: 'Cancel' })} />
    <MyGButton primary loading={loading} onClick={onCreate} text={intl.formatMessage({ id: 'myg.create', defaultMessage: 'Create' })} />
  </div>
)
...
export const Name = ({ onChange, intl }) => (
  <div className='team-input-container'>
    ...
    <MyGInput
      ...
      placeholder={intl.formatMessage({ id: 'teams.create.name-hint', defaultMessage: 'must be unique' })}
    />
  </div>
)
...
export const Hashtags = ({ intl, hashtags, onChange }) => (
  <div className='team-input-container'>
    ...
    <MyGTagSelect
      endpoint={'/api/team/tags'}
      tags={hashtags}
      onChange={onChange}
      placeholder={intl.formatMessage({ id: 'teams.create.hashtags-hint', defaultMessage: '#hello' })}
    />
  </div>
)
  ...
  <div className='team-input-container'>
    ...
    <MyGFriendSelect
      ...
      placeholder={intl.formatMessage({
        id: 'teams.create.moderators-hint',
        defaultMessage: "Enter your Friend's name to set them as a moderator"
      })}
      onChange={onChange}
    />
  </div>
...
export const Type = ({ type, onChange }) => (
  <div className='team-input-container'>
    ...
    <MyGSelect value={type} options={EXPERIENCE_OPTIONS} onChange={onChange} />
  </div>
)
...
export const Language = ({ language, onChange }) => (
  <div className='team-input-container'>
    ...
    <MyGSelect value={language} options={LANGUAGE_OPTIONS} onChange={onChange} />
  </div>
)
...
export const Region = ({ region, onChange }) => (
  <div className='team-input-container'>
    ...
    <MyGSelect value={region} options={REGION_OPTIONS} onChange={onChange} />
  </div>
)
  ...
  <div className='team-input-container team-checkbox'>
    ...
    <WithTooltip
      ...
      text={intl.formatMessage({
        id: 'teams.create.list-on-lft-tooltip',
        defaultMessage: 'Whether this team will appear on Looking for Teams'
      })}
    >
...
export const InviteFriends = ({ invitedFriends, onChange, intl }) => (
  <div className='team-input-container'>
    ...
    <MyGFriendSelect
      ...
      disabled={false}
      placeholder={intl.formatMessage({
        id: 'teams.create.invite-friends-hint',
        defaultMessage: 'Select up to ten of your friends to invite'
      })}
      onChange={onChange}
    />
  </div>
