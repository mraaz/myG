...
export default class IndividualApproval extends Component {
  ...
  clickedDenied = () => {
    let {approvals} = this.props
    try{
      const deleteInvite = axios.get(`/api/attendees/delete_myInvite/${approvals.attendees.schedule_games_id}/${approvals.attendees.user_id}`)
    } catch(error){
      console.log(error)
    }
    this.setState({
  ...
  render() {
    ...
    return (
      <div className="scheduledGamesApprovals-info">
        ...
        {this.state.dota_2_position_one && <div className="dota_2_position_one" onClick={() => this.clickUpdatePosition(1)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-one-key-first-3-512.png" height="40" width="40"></img></div>}
        {this.state.dota_2_position_one_ticked && <div className="dota_2_position_one" onClick={() => this.clickUpdatePosition(-1)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-one-key-first-3-512-Ticked.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_two && <div className="dota_2_position_two" onClick={() => this.clickUpdatePosition(2)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-two-key-3-512.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_two_ticked && <div className="dota_2_position_two" onClick={() => this.clickUpdatePosition(-2)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-two-key-3-512-Ticked.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_three && <div className="dota_2_position_three" onClick={() => this.clickUpdatePosition(3)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-three-keyboard-3-512.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_three_ticked && <div className="dota_2_position_three" onClick={() => this.clickUpdatePosition(-3)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-three-keyboard-3-512-Ticked.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_four && <div className="dota_2_position_four" onClick={() => this.clickUpdatePosition(4)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-four-keyboard-3-512.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_four_ticked && <div className="dota_2_position_four" onClick={() => this.clickUpdatePosition(-4)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-four-keyboard-3-512-Ticked.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_five && <div className="dota_2_position_five" onClick={() => this.clickUpdatePosition(5)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-five-keyboard-3-512.png" height="40" width="40"></img> </div>}
        {this.state.dota_2_position_five_ticked && <div className="dota_2_position_five" onClick={() => this.clickUpdatePosition(-5)}><img src="https://mygame-media.s3-ap-southeast-2.amazonaws.com/stock_images/number-five-keyboard-3-512-Ticked.png" height="40" width="40"></img> </div>}
        <div className="invitiation-options">
          {this.state.actionClicked && <div className="invitation-accept" onClick={this.clickedAccept}>
            Accept &nbsp;&nbsp;
          </div>}
          {this.state.actionClicked && <div className="invitation-deny" onClick={this.clickedDenied}>
            Deny&nbsp;&nbsp;
          </div>}
          {this.state.actionClickedAccept && <div className="invitation-accepted">
            Accepted! &nbsp;&nbsp;
          </div>}
          {this.state.actionClickedDeny && <div className="invitation-denied">
            Denied! &nbsp;&nbsp;
          </div>}
